var exam_id = null,
	...
	templates = {
		...
		group_list: function(data) {
			...
			return '<li><span class="text-wrap text-bold" data-group="'+data._id+'" data-action="group-view-exam">'+data.name+'</span><span class="pull-right text-muted">'+length+'</span></li>'
		},
		exam_list: function(data) {
			return '<li> <div class="clearfix"> <div class="chat-member"> <h6>'+data.name+' <small>/ '+data.questions.length+' câu, thời gian '+data.time / 60+' phút</small></h6> </div> <div class="chat-actions"> <a href="/test/'+data.link+'" class="btn btn-link btn-icon btn-xs" target="_blank"><i class="icon-marker"></i></a> <a class="btn btn-link btn-icon btn-xs" data-index="'+data._id+'" data-exam="'+data.link+'" data-action="get-histories" data-toggle="collapse" href="#histories'+data._id+'"><i class="icon-tree3"></i></a> </div> </div> <div class="panel-collapse collapse" id="histories'+data._id+'"> <div class="block"> <div class="row"> <div class="col-md-8"> <div id="chart'+data._id+'" class="graph"></div> </div> <div class="col-md-4"> <div class="container-fluid score-board"> <div> <p>Điểm số trung bình</p> <p>Số lần làm</p> <p>Thời gian làm trung bình</p> <p>Ngày làm gần nhất</p> </div> <div class="analytics-number text-right"></div> </div> </div> </div> </div> </div> </li>'
		},
...
var frontend_exam_loading_block = function(num) {
	var html = '';
	for (var i = 0; i < num; i++) {
		html += '<li class="fb-loading-wrapper"> <div class="fblw-timeline-item"> <div class="fblwti-animated"> <div class="fblwtia-mask fblwtia-title-line fblwtia-title-mask-0"></div> <div class="fblwtia-mask fblwtia-title-line fblwtia-title-mask-1"></div> <div class="fblwtia-mask fblwtia-sepline-sapo fblwtia-sapo-line-0"></div> <div class="fblwtia-mask fblwtia-sepline-sapo fblwtia-sapo-line-1"></div> <div class="fblwtia-mask fblwtia-sepline-sapo fblwtia-sapo-line-2"></div> <div class="fblwtia-mask fblwtia-sepline-sapo fblwtia-sapo-line-3"></div> </div> </div> </li>'
	}
	return html
};
